...
function jsBackend(
  ...
  // Build-output-named dirs by name alone, like rg's `!**/<dir>/**` globs in
  // universeArgs: the walk's exemption for git-tracked ones is not
  // expressible there, so both backends keep seeing the same files.
